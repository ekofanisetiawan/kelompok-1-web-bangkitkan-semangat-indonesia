        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                    ...
                    <p>Kami dari Kelompok 1 sebagai generasi muda tidak boleh berhenti berkreasi, berinovasi, dan berprestasi. Kita harus membuktikan kemahiran kita, kekuatan kita, dan ketangguhan kita. Kita harus meraih masa depan kita dan mewujudkan cita-cita para Pendiri Bangsa dengan Semangat Bela Negara salah satunya melalui Program MBKM PMM - PKBN.</p>
                    ...
                    foreach ($data as $row) : ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="service-item  position-relative">
                                <p><img src="<?= "http://localhost/bangkit_indonesia/admin/img_artikel/" . $row['gambar'] ?>" width="290" height="200"></p>
                                <h3><?= $row['judul'] ?></h3>
                                <p><?= $row['tanggal'] ?></p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    foreach ($data as $row) : ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="service-item  position-relative">
                                <p><img src="<?= "http://localhost/bangkit_indonesia/admin/img_gallery/" . $row['gambar'] ?>" width="290" height="200"></p>
                                <p><?= $row['keterangan'] ?></p>
                                <!-- <a href="detail_artikel.php?id_artikel=<?= $row['id_artikel'] ?>" class="readmore stretched-link">Read more <i class="bi bi-arrow-right"></i></a> -->
                            </div>
                        </div><!-- End Service Item -->
